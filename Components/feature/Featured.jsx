...
const Featured = () => {
    return (
        <div className='my-24'>
            <div className='md:relative flex flex-col md:block w-11/12 m-auto md:border-none border border-lightGray p-6 md:p-0 rounded-xl'>
                <div className='relative h-52 md:h-96'>
                    <Image src='/Container.png' fill alt='' />
                </div>

                <div className=' md:absolute -bottom-40 right-0 rounded-xl md:w-[60%] py-8 md:py-10 md:px-5 bg-white text-black font-body md:shadow-xl'>
                    <div className='flex items-center gap-3 mb-4'>
                        <h1 className='font-semibold text-lg text-black'>DEVELOPMENT</h1>
                        <p className='text-gray text-base'>16 March 2024</p>
                    </div>
                    <h1 className='font-heading text-3xl md:w-4/5 font-bold mb-5'>How to make a Game look more attractive with New VR & AI Technology</h1>

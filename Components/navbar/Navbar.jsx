...
const Navbar = () => {
    ...
    return (
        <div className='md:m-auto md:max-w-[90vw] py-7 flex justify-between items-center relative z-10'>
            <Link className='pl-5 lg:pl-0' href="/">
                <Image src="/Logo.png" alt='' width={120} height={40} />
            </Link>
            
            <div className='md:flex hidden font-heading text-black items-center gap-6 justify-end lg:w-[60%] md:w-full'>
                <div className='flex'>
                ...
                <div className='relative block w-full max-w-[53px] ease-in duration-300 overflow-hidden focus-within:max-w-[200px]'>
                    <input
                        ...
                        p-[5px] rounded-lg border-[none] outline-none placeholder:text-white placeholder:text-base focus-within:placeholder:text-gray 
